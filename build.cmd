...
SET SUMMARY="Elders.Pandora.GUI"
SET DESCRIPTION="Elders.Pandora.GUI"

%FAKE% %NYX% "target=%TARGET%" appName=Pandora.GUI appSummary=%SUMMARY% appDescription=%DESCRIPTION%